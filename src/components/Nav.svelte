		 ...
		 <!-- <a class="block mr-1 md:mr-2 lg:mr-10 p-2 rounded-full" href="/webinars">
			...
			<a class="block mr-1 p-2 lg:mr-10 rounded-full" href="/archive">
			  <img class="w-5 inline -mt-1 opacity-75" src="/ed-video.svg" alt="educational media" />
					<span class="hidden lg:inline">Talks </span> <span class="hidden sm:inline">Archive</span>
			</a>
...
{#if $page.path === '/'}
 ...
 <!-- Home page header logo with text -->
	<header class="flex justify-center mt-1 mb-3 z-10">
		 <img class='w-1/3 max-w-xs' src="/logo2.svg" alt='our logo: a lotus bloom'/>
	</header>
 <!-- Home page Nav links -->
	<nav class="flex justify-center items-center sticky bg-white">
		 ...
		 <!-- <a class="block mr-12 p-2 rounded-full" href="/news">
			...
			<a class="block mr-5 p-2 rounded-full" href="/archive">
			  <img class="w-5 inline -mt-1 opacity-75" src="/ed-video.svg" alt="educational media" />
					<span class="hidden sm:inline">Talks </span> <span class="hidden md:inline">Archive</span>
			</a>
